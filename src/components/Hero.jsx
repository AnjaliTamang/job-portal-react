    ...
    <div className='container 2xl:px-20 mx-auto my-10'>
       ...
       <div className='border border-gray-300 shadow-md mx-2 mt-5 p-6 rounded-md flex'>
        <div className='flex justify-center gap-10 lg:gap:16 flex-wrap'>
            ...
            <img className='h-6' src={assets.fuse_icon} alt="" />
            <img className='h-6' src={assets.cotiviti_icon} alt="" />
            <img className='h-6' src={assets.leapfrog_icon} alt="" />
            <img className='h-6' src={assets.braindigit_icon} alt="" />
            <img className='h-6' src={assets.deerwalk_icon} alt="" />
            <img className='h-6' src={assets.logpoint_icon} alt="" />
        </div>
        </div> 
